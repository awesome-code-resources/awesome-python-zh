...
* [pylibmc](https://github.com/lericson/pylibmc) - 周围的Python包装器[libmemcached](https://libmemcached.org/libMemcached.html)接口。
...
* [pytesseract](https://github.com/madmaze/pytesseract) - 的包装器[Google Tesseract OCR](https://github.com/tesseract-ocr)。
...
* [jsonschema](https://github.com/Julian/jsonschema) - 的实现[JSON Schema](http://json-schema.org/)对于Python。
...
* 类似pdb的调试器
    * [ipdb](https://github.com/gotcha/ipdb) - IPython-启用[pdb](https://docs.python.org/3/library/pdb.html)。
...
* 流处理
    * [faust](https://github.com/robinhood/faust) - 一个流处理库，从[Kafka Streams](https://kafka.apache.org/documentation/streams/)到Python。
    * [streamparse](https://github.com/Parsely/streamparse) - 通过以下方式针对实时数据流运行Python代码[Apache Storm](http://storm.apache.org/)。
...
* [path.py](https://github.com/jaraco/path.py) - 的模块包装器[os.path](https://docs.python.org/3/library/os.path.html)。
...
* [PyQt](https://doc.qt.io/qtforpython/) - 的Python绑定[Qt](https://www.qt.io/)跨平台应用程序和UI框架。
...
* [wand](https://github.com/dahlia/wand) - 的Python绑定[MagickWand](http://www.imagemagick.org/script/magick-wand.php),用于ImageMagick的C API。
...
* [PyICU](https://github.com/ovalhub/pyicu) - Unicode C库的国际组件包装 ([ICU](http://site.icu-project.org/))。
...
* [zeroRPC](https://github.com/0rpc/zerorpc-python) - zerorpc是一种灵活的RPC实现，基于[ZeroMQ](http://zeromq.org/)和[MessagePack](http://msgpack.org/)。

## 科学

*科学计算库。另请参阅 [Python-for-scientifics](https://github.com/TomNicholas/Python-for-scientifics)。*
